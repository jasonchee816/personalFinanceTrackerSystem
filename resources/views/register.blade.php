            ...
            <div class="col-lg-6">
                ...
                <form>
                    ...
                    <div class="form-floating mb-4">
                        <input type="name" id="name" name="name" placeholder="Name" class="form-control input-lg" />
                    ...
                    <!-- telNo input -->
                    <div class="form-floating mb-4">
                        <input type="number" id="telNo" name="telNo" placeholder="Telephon No" class="form-control input-lg" />
                        <label class="form-label" for="telNo">Telephone Number</label>
                    ...
                    <div class="form-floating mb-4">
                        <input type="password" id="comfirmPwd" name="comfirmPwd" placeholder="Comfirm Password" class="form-control input-lg" />
                        <label class="form-label" for="comfirmPwd">Comfirm Password</label>
                        <span style="color:red">@error('comfirmPwd'){{$message}}@enderror</span>
                    </div>
